...
#### 编写目的
本需求说明是针对‘家庭图书管理系统’编写的。其编写目的是管理家庭图书资产，方便家庭图书归类整理，用较小的成本在较短的时间找出图书所在和阅读情况
#### 背景
本系统名称为‘家庭图书管理系统’。为完成北大16级java设计作业，我们第10小组着手开发此图书管理系统。目前此系统只在chrome浏览器下进行调试，还没做其他浏览器的兼容
#### 需求
需要标识图书是电子书还是实体书
图书的增删改查
图书的阅读管理（已读，未读）
